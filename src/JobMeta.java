...
public class JobMeta {
	...
	public JobMeta(JobConf jconf) {
		...
		this.mapperClassName = JobTracker.JOB_CLASSPATH_PREFIX + this.jobId + "." + jconf.getMapperClassName();
		this.reducerClassName = JobTracker.JOB_CLASSPATH_PREFIX + this.jobId + "." + jconf.getReducerClassName();
